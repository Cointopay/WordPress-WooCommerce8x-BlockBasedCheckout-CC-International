...
class WC_CointopayCC_Gateway extends WC_Payment_Gateway {
	...
	public function cointopay_cc_include_custom_js()
	{
		...
		wp_enqueue_script('cointopay_cc_js', WC_Cointopay_CC_Payments::plugin_url() . '/assets/js/ctp_cc_custom.js', array('jquery'), null, false);
...
<?php
	...
	public function cointopay_cc_check_response()
	{
		...
		if((isset($_GET['wc-api']) && $_GET['wc-api'] == 'WC_CointopayCC_Gateway') && isset($_GET['CustomerReferenceNr']) && isset($_GET['TransactionID']))
		{
			global $woocommerce;
